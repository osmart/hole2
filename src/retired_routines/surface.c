...
int main (int argc, char *argv[])
{
  ...
  fprintf (stderr,"\n\nsurface: A Hole surface generation program\n");
  fprintf (stderr,"Copyright 1997-9 Guy M.P. Coates (gcoates@pugh.bip.bham.ac.uk)\n");
  fprintf (stderr,"This program is part of the HOLE suite of programs\n");
...
{ 
  ...
  int cull_count=0; 
   ...
   fprintf(stderr,"\n%i Zero area triangles culled.",cull_count); 
